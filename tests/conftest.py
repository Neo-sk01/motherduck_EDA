...
def curated_sample() -> pd.DataFrame:
    return pd.DataFrame(
        [
            ...
            {"queue_id": "8020", "date": "2026-04-02", "hour": 10, "dow": "Thursday", "call_id": "e", "agent_name": "Named Zero", "agent_sec": 0.0, "queue_sec": 11.0, "hold_sec": 0.0, "caller_number_norm": "2223334444", "queue_release_reason": "No Answer", "agent_release_reason": "No Answer", "handled_flag": "No Talk Time"},
        ]
    )
